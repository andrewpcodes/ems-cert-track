...
function Profile() {
  ...
  async function loadProfilePicture() {
    ...
    try {
      ...
      const loadEmail = loadUser.attributes["email"];
    ...
    <Container component="main">
      ...
      >
        <div>
          <Avatar
            src={profileLink}
            sx={{ width: 400, height: 400, float: "left" }}
          />
          <Card
            sx={{
              bgcolor: "#EFEFEF",
          ...
          >
            ...
            <CardContent sx={{ bgcolor: "" }}>
              ...
              <Typography variant="subtitle1" sx={{ marginTop: 1 }}>
                Certified Since: {certifiedSince}
              </Typography>
              <Typography variant="subtitle1" sx={{ marginTop: 1 }}>
                Years Certified: {yearsCertified}
              </Typography>
              <Typography variant="subtitle1" sx={{ marginTop: 1 }}>
                Next Certification Exam: {certDate.getMonth() + 1}/
                {certDate.getDate()}/{certDate.getFullYear() + 2}
              </Typography>
              <Typography variant="subtitle1" sx={{ marginTop: 1 }}>
                City: {city}
              </Typography>
      ...
      >
        <div>
          ...
          <div>
            ...
            <Button onClick={downloadCertification}>
