...
function Login() {
  ...
  async function signIn(event: React.FormEvent<HTMLFormElement>) {
    ...
    async function confirmForgotPassword(event: React.FormEvent<HTMLFormElement>) {
        event.preventDefault();
        try { 
    ...
    return (
        <div>
            ...
            {visible && !confirm && (
                ...
                <TextField
                    ...
                    onChange={(e) => setEmail(e.target.value)}
                        ...
                        {alert ? (
                            <Alert severity="error">This email was not detected in our system</Alert>
                        ) : null}
            ...
            {visible && confirm && (
                ...
                <Box component="form" onSubmit={confirmForgotPassword} sx={{ mt: 1 }}>
                    <TextField
                        margin="normal"
                        required
                        fullWidth
